...
export class PaginatedQueryMoviesRequestDto extends PaginatedQueryRequestDto {
  ...
  @ApiPropertyOptional({ type: [String], description: 'Filter by genres', example: ['Action', 'Sci-Fi'] })
  @IsOptional()
  @Transform(({ value }) =>
  ...
  @ApiPropertyOptional({ type: String, description: 'Minimum age rating', example: 'P' })
  @IsOptional()
  @IsString()
  ratingAge?: string;
