...
export class RoomResponseDto {
  @ApiProperty({ type: String, description: 'Room ID', example: '64b0c2f8e1f2a3a5d6b7c8d0' })
  @Expose()
  _id!: string;

  @ApiProperty({ type: String, description: 'Theater ID', example: '64b0c2f8e1f2a3a5d6b7c8d0' })
  @Expose()
  theaterId!: string;
  ...
  @ApiProperty({ type: String, enum: ROOM_TYPES, description: 'Type of room', example: '2D' })
  @Expose()
  roomType!: RoomType;
  ...
  seatMap!: (SeatResponseDto | null)[][];

  @ApiPropertyOptional({ type: Boolean, description: 'Room is active', example: true })
  @Expose()
  isActive?: boolean;
